    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='container p-8 mt-6'>
          ...
          <div>
            <button type="submit" className='bg-[#c60e34] mt-10 mr-2 hover:bg-[#981032]' ref={submitButton}>{submittext}</button>
            <button onClick={() => router.push('/')} className='bg-gray-600 hover:bg-gray-700'>Return home</button>
          </div>
