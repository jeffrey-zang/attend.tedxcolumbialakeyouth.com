    ...
    <main>
      <div onClick={() => router.push('/apply/attendee')} className='p-10 container cursor-pointer opacity-100 hover:opacity-75 transition-opacity'>
        <div className='flex justify-between items-center'>
          ...
          <button onClick={() => router.push('/apply/attendee')} className='flex items-center gap-1 text-lg hover:gap-3'>
            I want to attend
            <BiRightArrowAlt />
          </button>
        </div>
      ...
      <div onClick={() => router.push('/apply/speaker')} className='p-10 container cursor-pointer opacity-100 hover:opacity-75 transition-opacity mt-8'>
        <div className='flex justify-between items-center'>
          ...
          <button onClick={() => router.push('/apply/speaker')} className='flex items-center gap-1 text-lg hover:gap-3'>
            I want to speak
            <BiRightArrowAlt />
          </button>
        </div>
